...
# Get options
usage = 'pattern_detector.py [-d <pattern_dimensions>] [ -i <pattern_indexes> ::= <pattern>;<pattern>;... where <pattern> ::= <index>,<index>,...] [-q <signal_quantizer> ::= <minimum>,<increment>] [-p <noise_probability>] [-n <dataset_size>] [-h <hidden_neuron_dimensions>] [-e <epochs>] [-r <random seed>]'
try:
